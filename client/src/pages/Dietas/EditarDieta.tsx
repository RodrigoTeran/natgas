                    ...
                    <div className={styles.micros}>
                        <div className={styles.micros_info}>
                            ...
                            <div className={styles.micros_col}>
                                ...
                                <input type="number" min="0" step="0.001"  placeholder="Potasio" id="real_potasio" name="real_potasio" required onChange={(e) => {setNutrients("Potasio", e.target.value.toString(), 0)}} value={micros["Potasio"]}/> <br/>

                                <label htmlFor="real_sodio">Sodio (μg)</label> <br/>
                                <input type="number" min="0" step="0.001"  placeholder="Sodio" id="real_sodio" name="real_sodio" required onChange={(e) => {setNutrients("Sodio", e.target.value.toString(), 0)}} value={micros["Sodio"]}/> <br/>

                                <label htmlFor="real_zinc">Zinc (μg)</label> <br/>
                                <input type="number" min="0" step="0.001"  placeholder="Zinc" id="real_zinc" name="real_zinc" required onChange={(e) => {setNutrients("Zinc", e.target.value.toString(), 0)}} value={micros["Zinc"]}/> <br/>

                                <label htmlFor="real_magnesio">Magnesio (μg)</label> <br/>
                                <input type="number" min="0" step="0.001"  placeholder="Magnesio" id="real_magnesio" name="real_magnesio" required onChange={(e) => {setNutrients("Magnesio", e.target.value.toString(), 0)}} value={micros["Magnesio"]}/> <br/>

                                <label htmlFor="real_vitaminaB6">Vitamina B6 (μg)</label> <br/>
                                <input type="number" min="0" step="0.001"  placeholder="Vitamina B6" id="real_vitaminaB6" name="real_vitaminaB6" required onChange={(e) => {setNutrients("Vitamina B6", e.target.value.toString(), 0)}} value={micros["Vitamina B6"]}/> <br/>
                                
                                <label htmlFor="real_vitaminaB12">Vitamina B12 (μg)</label> <br/>
                                <input type="number" min="0" step="0.001"  placeholder="VitaminaB12" id="real_vitaminaB12" name="real_vitaminaB12" required onChange={(e) => {setNutrients("Vitamina B12", e.target.value.toString(), 0)}} value={micros["Vitamina B12"]}/> <br/>

                                <label htmlFor="real_acFolico">Ácido fólico (μg)</label> <br/>
                                <input type="number" min="0" step="0.001"  placeholder="Ácido fólico" id="real_acFolico" name="real_acFolico" required onChange={(e) => {setNutrients("Ácido fólico", e.target.value.toString(), 0)}} value={micros["Ácido fólico"]}/> <br/>
                                
                                <label htmlFor="real_folato">Folato Eq. (μg)</label> <br/>
                                <input type="number" min="0" step="0.001"  placeholder="Folato eq" id="real_folato" name="real_folato" required onChange={(e) => {setNutrients("Folato Eq.", e.target.value.toString(), 0)}} value={micros["Folato Eq."]}/> <br/>
                            </div>
                        </div>
                    </div>
                </div>
