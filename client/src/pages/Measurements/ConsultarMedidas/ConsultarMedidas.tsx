					...
					<div className={styles.filters}>
						...
						<div className={styles.names}>
							...
							<input
								...
								onChange={(e) => {
									e.target.value === ""
										? setStart("0000-01-01 00:00:00")
										: setStart(e.target.value + " 00:00:00");
								}}
							/>
						</div>
						...
						<div className={styles.names}>
							...
							<input
								...
								onChange={(e) => {
									e.target.value === ""
										? setEnd("9999-12-31 23:59:59")
										: setEnd(e.target.value + " 23:59:59");
								}}
							/>
						</div>
					</div>
						...
						<table className={styles.table}>
							...
							{measures.length == 0 && (
								<div className={styles.workoutless_container}>
									<img className={styles.workoutless_img} src={danger} />
									<p className={styles.p_workoutsless}>
										No haz seleccionado una medida
									</p>
									<p className={styles.p_workoutsless_bold}>
										Selecciona medida para consultar, editar o borrar los
										registros
									</p>
								</div>
							)}
													...
													<td>
														<div className={styles.img}>
															<img
																src={pencil}
																onClick={(e) =>
																	edit(element.id, element.measurement)
																}
															/>
															<img
																src={trash}
																onClick={(e) => del(element.id)}
															/>
														</div>
													</td>
												</tr>
