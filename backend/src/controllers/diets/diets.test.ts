import "jest";
import { getAllLogic, getAllFavsLogic, getDietLogic } from "./diets.controller";
			...
			diets: [
				{
					...
					liked: undefined,
					macros:
						'[{"proteina": ["2g", "7g"], "grasas": ["5g", "4g"], "carbohidratos": ["4g", "3g"]}]',
					micros: {},
					name: "1500",
				},
				{
					...
					liked: undefined,
					macros:
						'[{"proteina": ["6g", "5g"], "grasas": ["5g", "1g"], "carbohidratos": ["7g", "3g"]}]',
					micros: {},
					name: "2000",
				},
				{
					...
					liked: undefined,
					macros:
						'[{"proteina": ["6g", "5g"], "grasas": ["7g", "8g"], "carbohidratos": ["7g", "8g"]}]',
					micros: {},
					name: "2500",
				},
				{
					...
					liked: undefined,
					macros:
						'[{"proteina": ["1g", "5g"], "grasas": ["5g", "4g"], "carbohidratos": ["4g", "1g"]}]',
					micros: {},
					name: "3000",
				},
				{
					...
					liked: undefined,
					macros:
						'[{"proteina": ["6g", "5g"], "grasas": ["2g", "4g"], "carbohidratos": ["7g", "3g"]}]',
					micros: {},
					name: "3500",
				},
				{
					...
					liked: undefined,
					macros:
						'[{"proteina": ["6g", "5g"], "grasas": ["2g", "4g"], "carbohidratos": ["2g", "3g"]}]',
					micros: {},
					name: "4000",
				},
			],
			favs: ["uuidD005", "uuidD006"],
			top3: [
				{
					calories: 3500,
					id: "uuidD005",
